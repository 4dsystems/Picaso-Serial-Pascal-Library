...
Picaso-Serial-Pascal-Library
=============================

Pascal Library for 4D Systems Serial Environement for Picaso based modules
...
This library provides high level functions for Pascal based platforms, to ease communication with Picaso based modules when using the module configured for Serial.
